...
export default {
  ...
  methods: {
    ...
    RunSimulation() {
      ...
      if(this.nowFileName === "clusterHiera")
      {
        // console.log("yes")
        let tmp_colors=[
          [49,130,189],[107,174,214],[158,202,225],[198,219,239],
          [230,85,13],[253,141,60],[252,174,107],[253,208,162],
          [49,163,84],[116,196,118],[161,217,155],[199,233,192],
          [117,107,177],[158,154,200],[203,139,203],[218,218,235],
          [112, 128, 144],[30, 144, 255],[128, 70, 0],[128, 128, 128],
        ]
        // [117,107,177],[158,154,200],[188,189,220],[218,218,235],
        tmp_colors = tmp_colors.map((x) => [
          x[0] / 255,
          x[1] / 255,
          x[2] / 255,
          1,
        ...
        .attr("color", (d) => tmp_colors[d.group % 20]);
      this.snodesSelected
